...
const FIELDS = {
  name: { x: 0.195, yTop: 0.3384 },
  surname: { x: 0.2137, yTop: 0.3727 },
  dob: { x: 0.2661, yTop: 0.4061 },
  clan: { x: 0.1774, yTop: 0.4365 },
  address: { x: 0.2056, yTop: 0.4699 },
  idNo: { x: 0.4037, yTop: 0.6386 },
  gender: { x: 0.3935, yTop: 0.6738 },
  issuedOn: { x: 0.7419, yTop: 0.6002 },
};
...
const PHOTO_BOX = { left: 0.0887, right: 0.2747, top: 0.5607, bottom: 0.7289 };
