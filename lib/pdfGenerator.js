...
const FIELDS = {
  name: { x: 0.195, yTop: 0.3354 },
  surname: { x: 0.2137, yTop: 0.3697 },
  dob: { x: 0.2661, yTop: 0.4053 },
  clan: { x: 0.1774, yTop: 0.4357 },
  address: { x: 0.2056, yTop: 0.4692 },
  idNo: { x: 0.4057, yTop: 0.6386 },
  gender: { x: 0.3935, yTop: 0.6746 },
  issuedOn: { x: 0.7419, yTop: 0.6029 },
};
