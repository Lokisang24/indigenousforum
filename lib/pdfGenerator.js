...
const FIELDS = {
  name: { x: 0.195, yTop: 0.3345 },
  surname: { x: 0.2137, yTop: 0.3688 },
  dob: { x: 0.2661, yTop: 0.4045 },
  clan: { x: 0.1774, yTop: 0.4351 },
  address: { x: 0.2056, yTop: 0.4683 },
  idNo: { x: 0.4073, yTop: 0.6386 },
  gender: { x: 0.3935, yTop: 0.6753 },
  issuedOn: { x: 0.7419, yTop: 0.6039 },
};
