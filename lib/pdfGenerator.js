...
const FIELDS = {
  name: { x: 0.195, yTop: 0.3365 },
  surname: { x: 0.2137, yTop: 0.3707 },
  dob: { x: 0.2661, yTop: 0.4057 },
  clan: { x: 0.1774, yTop: 0.4364 },
  address: { x: 0.2056, yTop: 0.4689 },
  idNo: { x: 0.4043, yTop: 0.6386 },
  gender: { x: 0.3935, yTop: 0.6749 },
  issuedOn: { x: 0.7419, yTop: 0.6024 },
};
