...
const FIELDS = {
  ...
  idNo: { x: 0.4073, yTop: 0.6271 },
  gender: { x: 0.3710, yTop: 0.6642 },
  issuedOn: { x: 0.7419, yTop: 0.5901 },
};
...
async function generateCertificatePdf(application, photoBytes = null) {
  ...
  // ---------------------------------------------------------------
  // Page 2 (mandatory on every certificate): organizational background,
  // historical context, and certificate terms — written entirely in
  // Indigenous Forum's own voice.
  // ---------------------------------------------------------------
